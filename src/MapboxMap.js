...
export default function MapboxMap({ missions, churches = [], onMissionClick }) {
  ...
  useEffect(() => {
    ...
    map.current.on("load", () => {
      ...
      // ── Mission pins — native GeoJSON layer (moves perfectly with map) ────
      ...
      // ── Click — fly to + open mission detail ─────────────────────────────
  ...
  return (
    <div style={{ position:"relative", borderRadius:20, overflow:"hidden",
      ...
      <div style={{
        ...
        {[
          ["✝", "#e8b34b",  "Active Mission"],
          ["✝", "#3ecf8e",  "Completed Mission"],
          ["🔒", "#b06cf5", "Protected Mission"],
          ["⛪", "#5b9cf6", "Verified Church"],
          ["●", "#e85b5b",  "Unreached Region"],
      ...
      <div style={{
        ...
        <div style={{ fontSize:12, fontWeight:700, color:"#e8b34b",
          letterSpacing:2, fontFamily:"Georgia, serif" }}>WORLD MISSION MAP</div>
